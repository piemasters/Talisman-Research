export default function Example() {
  return (
    <>
      <button
        type="button"
        className="px-2 py-1 text-xs font-semibold text-white bg-indigo-500 rounded shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
      >
        Button text
      </button>
      <button
        type="button"
        className="px-2 py-1 text-sm font-semibold text-white bg-indigo-500 rounded shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
      >
        Button text
      </button>
      <button
