                ...
                <div className="relative flex gap-x-3">
                  <div className="flex items-center h-6">
                    <input
                      ...
                      name="comments"
                      type="checkbox"
                      className="w-4 h-4 text-indigo-600 rounded border-white/10 bg-white/5 focus:ring-indigo-600 focus:ring-offset-gray-900"
                    />
                  </div>
              ...
              <div className="mt-6 space-y-6">
                <div className="flex items-center gap-x-3">
                  <input
                    ...
                    type="radio"
                    className="w-4 h-4 text-indigo-600 border-white/10 bg-white/5 focus:ring-indigo-600 focus:ring-offset-gray-900"
                  />
                  <label
