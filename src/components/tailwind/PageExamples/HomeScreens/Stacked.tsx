        ...
        <div className="relative pt-16 overflow-hidden isolate">
          ...
          <header className="pt-6 pb-4 sm:pb-6">
            <div className="flex flex-wrap items-center gap-6 px-4 mx-auto max-w-7xl sm:flex-nowrap sm:px-6 lg:px-8">
              ...
              <a
                href="#"
                className="flex items-center px-3 py-2 ml-auto text-sm font-semibold text-white bg-indigo-600 rounded-md shadow-sm gap-x-1 hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                                  ...
                                  <div className="flex-auto">
                                    <div className="flex items-start gap-x-3">
                                      ...
                                      <div
                                        className={classNames(
                                          statuses[
                                            transaction.status as StatusType
                                          ],
