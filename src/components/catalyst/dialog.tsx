...
import clsx from "../talisman/util/clsx";
    ...
    <HeadlessTransition appear as={Fragment} show={open} {...props}>
      <HeadlessDialog onClose={onClose}>
        <HeadlessTransitionChild
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 flex justify-center w-screen px-2 py-2 overflow-y-auto bg-zinc-950/25 focus:outline-0 sm:px-6 sm:py-8 lg:px-8 lg:py-16 dark:bg-zinc-950/50" />
        </HeadlessTransitionChild>

        <HeadlessTransitionChild
          className="fixed inset-0 w-screen pt-6 overflow-y-auto sm:pt-0"
          enter="ease-out duration-100"
